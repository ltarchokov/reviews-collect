...
Или сразу задача: «мне нужны отзывы по шинам Gislaved» — агент покажет,
в каких категориях бренд есть на WB, спросит, какую собирать (или сразу
соберёт, если категория одна), и отдаст книгу Excel.
